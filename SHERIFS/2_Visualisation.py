...
class checking_the_input():
    def __init__(self):       
        ...
        self.Run_name = 'HFFtest'
        self.File_geom = 'data/HFF/fault_geometry.txt'
        self.FileName_Prop = 'data/HFF/fault_properties_up.txt'
        self.File_bg = 'data/HFF/Background_geometry.txt'
        self.completness_file = 'data/HFF/completness.txt'
        ...
        self.end_year_of_catalog = 2018

        self.llcrnrlon=-19
        self.llcrnrlat=65.95
        self.urcrnrlon=-17
        self.urcrnrlat=66.4
